...
VALUES ('Laptop', 'This is some description for laptop!', 'CAT_1.png', true);

INSERT INTO category (name, description, image_url, is_active) 
VALUES ('Television', 'This is some description for television!', 'CAT_2.png', true);

INSERT INTO category (name, description, image_url, is_active) 
VALUES ('Mobile', 'This is some description for mobile!', 'CAT_3.png', true);
...
VALUES (2, '102 Sabarmati Society, Mahatma Gandhi Road', 'Near Salt Lake', 'Kolkata', 'West Bengal', 'India', '33001', true, false);
